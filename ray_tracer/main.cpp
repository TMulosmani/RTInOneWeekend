...
hittable_list random_scene() {
    ...
    for (int a = -11; a < 11; a++) {
        for (int b = -11; b < 11; b++) {
            ...
            point3 center(a + 0.5*random_double(), 0.2, b + 0.5*random_double());
            ...
            if ((center - point3(4, 0.2, 0)).length() > 0.9) {
                ...
                if (choose_mat < 0.8) {
                    ...
                    auto center2 = center + vec3(0, random_double(0,.25), 0);
...
int main() {
    ...
    for (int j = image_height-1; j >= 0; --j) {
        ...
        for (int i = 0; i < image_width; ++i) {
			...
			pixel_color = vec3(sqrt(pixel_color.r()),sqrt(pixel_color.g()),sqrt(pixel_color.b()));
   ...
   std::cout << "Time taken by program is : " << std::fixed << time_taken << std::setprecision(2); 
